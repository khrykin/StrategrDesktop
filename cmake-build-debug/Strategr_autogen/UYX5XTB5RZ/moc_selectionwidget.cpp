...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SelectionWidget_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(2, 33, 0) // ""
    ...
    "SelectionWidget\0selectionChanged\0"
};
...
void SelectionWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SelectionWidget::selectionChanged)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SelectionWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SelectionWidget.data,
    qt_meta_data_SelectionWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *SelectionWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectionWidget.stringdata0))
...
// SIGNAL 0
void SelectionWidget::selectionChanged()
{
