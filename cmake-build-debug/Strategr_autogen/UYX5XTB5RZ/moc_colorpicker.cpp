...
QT_MOC_LITERAL(3, 26, 21), // "std::optional<QColor>"
QT_MOC_LITERAL(4, 48, 5) // "color"

    },
    "ColorPicker\0colorChanged\0\0"
    "std::optional<QColor>\0color"
};
...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->colorChanged((*reinterpret_cast< const std::optional<QColor>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (ColorPicker::*)(const std::optional<QColor> & );
...
// SIGNAL 0
void ColorPicker::colorChanged(const std::optional<QColor> & _t1)
{
